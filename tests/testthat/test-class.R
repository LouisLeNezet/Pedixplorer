test_that("Class ped work", {
    ...
    expect_equal(length(as.list(ped0)), 16)
    expect_equal(dim(as.data.frame(ped0)), c(0, 16))
    ...
    expect_equal(length(as.list(ped2)), 16)
    expect_equal(dim(as.data.frame(ped2)), c(2, 16))
    ...
    expect_equal(length(as.list(ped3)), 19)
    expect_equal(dim(as.data.frame(ped3)), c(3, 19))
    ...
    expect_equal(dim(as.data.frame(ped5)), c(5, 18))
