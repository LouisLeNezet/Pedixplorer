...
```{r, ped1, fig.alt = "Pedigree of family 1"}
...
```{r, status, fig.alt = "Pedigree of family 2 with different vital status"}
...
```{r, two_affection, fig.alt = "Pedigree of family 2 with two affection indicators"}
...
```{r, twins, fig.alt = "Pedigree of family 2 with special relationships"}
...
plot(ped1, legend = TRUE, leg_loc = c(7, 18, 1, 1.5))
```
