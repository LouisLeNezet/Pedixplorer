...
```{r, polygons, fig.alt = "Different polygons"}
library(Pedixplorer)
types <- c(
...
There are three main symbols corresponding to the three sex codes: square = male,
circle = female, diamond= unknown. A triangle is use to represent miscarriage.
...
```{r, interactive_plot, fig.alt = "Interactive plot", eval = FALSE}
data(sampleped)
