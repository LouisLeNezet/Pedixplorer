...
```{r, auto_hint1, echo = FALSE, fig.dim = c(10, 8), fig.alt="Comparison of auto_hint on a simple pedigree"}
...
```{r, align2, echo = FALSE, fig.dim = c(10, 8), fig.alt = "Comparison of auto_hint on a more complex pedigree"}
#
