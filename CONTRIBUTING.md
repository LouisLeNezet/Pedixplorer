...
We try to manage the required tasks for Pedixplorer using GitHub issues,
you probably came to this page when creating one.

## Contribution workflow

If you’d like to write some code for Pedixplorer, the standard workflow
is as follows:

1.  Check that there isn’t already an issue about your idea in the
    [Pedixplorer](https://github.com/LouisLeNezet/Pedixplorer/issues) to
    avoid duplicating work. If there isn’t one already, please create
...
2.  [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo)
    the [Pedixplorer
    repository](https://github.com/LouisLeNezet/Pedixplorer/) to your
    GitHub account
...
5.  Submit a Pull Request against the `devel` branch and wait for the
...
Typically, pull-requests are only fully reviewed when these tests are
passing, though of course we can help out before then.

## Patch

⚠️ Only in the unlikely and regretful event of a release happening with
a bug.
...
If you wish to contribute a new function, please use the following
coding standards:
